...
napi_value GetModuleCreator(const Napi::CallbackInfo& info) {
  ...
  auto* creator_api = new lynx_extension_module_creator_api_t{
      .create_module_func = http_service_extension_module_create_extension_module,
  };

  auto result = Napi::Object::New(env);
  result.Set("name", Napi::String::New(env, "HttpServiceExtensionModule"));
...
NODE_API_MODULE(lynx_http_service_module, Init)
