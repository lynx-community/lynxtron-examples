...
import { DemoPage, Section, Paragraph, Code, ResultText, KV } from '../../shared/ui/Demo';
...
//
// In Lynxtron the launcher already builds this window with
  ...
  return (
    <DemoPage title="Native Window Controls" supports="titleBarStyle: hidden · native controls kept">
      ...
      <Section>
        ...
        <Paragraph>
          Lynxtron keeps Electron's main-process window API, so the launcher
