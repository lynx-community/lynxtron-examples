...
import { DemoPage, Section, Row, ActionButton, KV, Paragraph, Code, ResultText } from '../../shared/ui/Demo';
...
//
// The port keeps that role: the launcher opens this one with no window
