...
import { bridgeSend, bridgeCall, onGlobalEvent } from '../../shared/bridge';
import './App.css';
...
//
// The launcher already builds THIS window with `frame: false` (from the
      ...
      <DemoPage title="Frameless Window" supports="frame: false · in-content controls">
        ...
        <Section>
          <Paragraph>
            ...
            API — only the Chromium renderer is replaced by Lynx. The launcher
