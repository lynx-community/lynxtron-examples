...
import { Section, Paragraph, Code } from '@lynxtron-examples/fiddle-kit/ui/Demo';
import './styles.css';
...
//
// Lynxtron keeps Electron's window model but swaps Chromium for Lynx. This fiddle's main.ts
      ...
      <view className="explainer-card">
        ...
        <Section>
          <Paragraph>
            ...
            same window model — this fiddle's main.ts applies{' '}
