...
export default defineConfig({
  ...
  plugins: [
    ...
    // AutoLink replaces the CEF subpath with its relocatable native proxy and
    // stages the addon and CEF resources in production builds too. Do not mark
    // that subpath external: a standalone dist must not resolve source modules.
